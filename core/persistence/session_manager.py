...
class SessionManager:
    ...
    def update_segment_frame(self, session_id: str, segment_index: int, frame_type: str, image_path: str, image_id: str = None) -> bool:
        """更新单个首/尾帧路径
        ...
        for frame in segment_frames:
            if frame.get('segment_index') == segment_index:
                if frame_type == "first":
                    frame['first_image_path'] = image_path
                    if image_id:
                        frame['first_image_id'] = image_id
                else:
                    frame['last_image_path'] = image_path
                    if image_id:
                        frame['last_image_id'] = image_id
                updated = True
                break
